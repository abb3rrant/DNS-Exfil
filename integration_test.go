...
func TestIntegrationEndToEndTXT(t *testing.T) {
	baseDomain := "exfil.test.local"
	encKey := "integration-test-key"
	...
	// Create test file with known content.
	testContent := []byte("Hello from the DNS exfiltration TXT integration test!\n" +
		"This is a multi-line file that will be encrypted, chunked,\n" +
		"sent over DNS TXT queries, reassembled, decrypted, and verified.\n" +
		"If you can read this, TXT mode worked!\n")
	...
	t.Logf("TXT integration test passed: %d bytes transferred successfully", len(testContent))
}
